...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> register(@RequestBody RegisterRequest request, HttpServletRequest requestContext, HttpServletResponse response) {
    ...
    public ResponseEntity<String> verifyEmail(@RequestParam String token) {
        ...
        return isVerified ? ResponseEntity.ok("Email verified successfully") : ResponseEntity.badRequest().body("Verification failed");
    }
}