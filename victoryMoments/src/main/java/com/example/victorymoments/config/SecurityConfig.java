    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/users/{userEmail}/profile").permitAll()
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/users/{userEmail}/profile").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/users/{userEmail}/avatar").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/users/find-friends").authenticated()
