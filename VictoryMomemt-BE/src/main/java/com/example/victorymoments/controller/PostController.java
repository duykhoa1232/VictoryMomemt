...
public class PostController {
    ...
    private String getAuthenticatedUserId() {
        ...
        return userRepository.findByEmail(username)
                .map(User::getId)
                .orElseThrow(() -> new UnauthorizedException(ErrorCode.USER_NOT_FOUND, username));
    }
    ...
    public ResponseEntity<Void> deletePost(
        ...
        postService.deletePost(id, getAuthenticatedUserId());
    ...
    public ResponseEntity<PostResponse> toggleLike(
        ...
        PostResponse updatedPost = postService.toggleLike(id, getAuthenticatedUserId());
