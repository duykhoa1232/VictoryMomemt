...
//         console.log('Trang hiện tại (từ backend):', response.number);
//       },
//       error: (err) => {
...
//
//             // Tùy chọn: nếu số bài đăng hiện tại ít hơn pageSize
//             // và vẫn còn bài để tải (totalPosts > posts.length),
//             // bạn có thể cân nhắc gọi loadPosts() để điền vào chỗ trống.
//             // Tuy nhiên, với "Load More", người dùng sẽ tự bấm để tải thêm.
//             // this.getPosts(); // Có thể không cần thiết với "Load More"
//           },
//           error: (err) => {
