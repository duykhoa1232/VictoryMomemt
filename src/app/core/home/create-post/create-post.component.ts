...
//           this.snackBar.open('Không thể lấy vị trí hiện tại.', 'Đóng', { duration: 3000 });
//         }
//       );
//     } else {
//       this.snackBar.open('Trình duyệt không hỗ trợ định vị.', 'Đóng', { duration: 3000 });
//     }
//   }
//
...
//
//         this.snackBar.open('Đã tự động điền địa chỉ.', 'Đóng', { duration: 2000 });
//       })
//       .catch(error => {
//         console.error('Lỗi khi gọi Nominatim:', error);
//         this.snackBar.open('Không thể lấy địa chỉ từ tọa độ.', 'Đóng', { duration: 3000 });
//       });
//   }
//
// }
